...
export default function Regione(){
    ...
    async function caricamento() {
        ...
        if(mappa.current == undefined){
            costruzioneMappa(mappa,REGIONI["TUTTE LE REGIONI"].coordinate[0],REGIONI["TUTTE LE REGIONI"].coordinate[1],6.3)
        }
    ...
    function filtraLista (codice){
        let areaFiltrata = listaAree.find(e=>
            e.codice == codice)
        setAreaSelezionata(areaFiltrata)
                    ...
                    <div className={"col-md-4 d-flex flex-column"}>
                        {regioni && regioni.map((regione,index)=>(
                            <>
                                ...
                                {(regioneSelezionata == regione && regioneSelezionata != "TUTTE LE REGIONI") && listaAree.map((area,index)=>(
